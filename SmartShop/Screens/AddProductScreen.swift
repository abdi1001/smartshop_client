...
struct AddProductScreen: View {
    ...
    private func saveOrUpdateProduct() async {
        ...
        do {
            ...
            let product = Product(id: self.product?.id, name: name, price: price, description: description, photoUrl: downloadURL, userId: userId)
...
#Preview("Updating Product") {
    NavigationStack {
        AddProductScreen(product: .preview)
    }
    .environment(ProductStore(httpClient: .development))
    .environment(\.uploaderDownloader, UploaderDownloader(httpClient: .development))
}
